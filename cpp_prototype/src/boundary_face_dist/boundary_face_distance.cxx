#include "boundary_face_distance.h"

void Boundary_Face_Distance::run_boundary_face_distance_calculation(Vol *vol, 
									double *distance_mapping)
{
	// Volume information
...
void Boundary_Face_Distance::boundaryFaceDist(int scheme,
...
double Boundary_Face_Distance::distToClosetFacePointOfCFV(
							float *sp2,
							int i, int j, int k,
...
double Boundary_Face_Distance::distToFacePoint(int unchanged, // which dimension stays unchanged
						float *sp2,
						double i, double j, double k,
...
double Boundary_Face_Distance::calcDist(float *sp2,
					double i, double j, double k,
...
bool Boundary_Face_Distance::isKthBitSet(int n, int k)
{
    if (n & (1 << (k - 1)))
        return 1;
    else
